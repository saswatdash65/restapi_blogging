...
Articles Users::getArticle(const DbClientPtr &clientPtr) const {
...
void Users::getArticle(const DbClientPtr &clientPtr,
                       const std::function<void(Articles)> &rcb,

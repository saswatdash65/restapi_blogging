...
class Articles
{
  public:
    struct Cols
    {
        ...
        static const std::string _authorId;
    ...
    const bool &getValueOfPublished() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<bool> &getPublished() const noexcept;
    ///Set the value of the column published
    void setPublished(const bool &pPublished) noexcept;

    /**  For column authorId  */
    ///Get the value of the column authorId, returns the default value if the column is null
    const std::string &getValueOfAuthorid() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<std::string> &getAuthorid() const noexcept;
    ///Set the value of the column authorId
  ...
  private:
    ...
    std::shared_ptr<bool> published_;
